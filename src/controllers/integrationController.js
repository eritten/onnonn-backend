...
module.exports = {
  ...
  webinarPollResponse: asyncHandler(async (req, res) => res.status(201).json({ response: await PollResponse.create({ poll: req.params.pollId, guestName: req.body.guestName, selectedOption: req.body.selectedOption }) })),

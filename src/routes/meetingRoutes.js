...
router.post("/:meetingId/reactions", optionalAuthMiddleware, controller.react);
...
router.post("/polls/:pollId/responses", optionalAuthMiddleware, validate(respondPollSchema), controller.respondPoll);
...
router.get("/:meetingId/questions", optionalAuthMiddleware, controller.listQuestions);
...
router.get("/:meetingId/chat", optionalAuthMiddleware, controller.listChat);
...
router.get("/:meetingId/whiteboard", optionalAuthMiddleware, controller.getWhiteboard);
router.put("/:meetingId/whiteboard", optionalAuthMiddleware, controller.updateWhiteboard);
